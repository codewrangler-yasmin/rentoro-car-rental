          ...
          <div className="p-6 lg:p-8">
            ...
            <div className="">
              <p className="mt-4 text-gray-600">
                ...
                convallis enim eget laoreet. Aenean vitae nisl mollis, porta
                risus vel, dapibus lectus. Etiam ac suscipit eros, eget maximus.
              </p>
            </div>
            ...
            <div className="mt-6 flex space-x-4">
              <button
                onClick={() => document.getElementById("book_now").showModal()}
